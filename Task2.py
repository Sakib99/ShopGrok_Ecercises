# -*- coding: utf-8 -*-
"""
Created on Sat Nov 27 23:42:24 2021
...
product_count_int = int(re.findall(r'\d{1,9}',product_count_text)[0]
...
for url in generic_urls:
  special_sequence = re.findall(regex,url)[-1]
...
regex ="\[(.*)\]"
product_storage_parsed = '['+ re.findall(regex,product_storage_string_raw)[1]+']'
